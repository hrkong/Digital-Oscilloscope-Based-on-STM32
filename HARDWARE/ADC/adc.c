...
u16 Get_Adc144(u8 ch)   
{
	  	//设置指定ADC的规则组通道，一个序列，采样时间
	ADC_RegularChannelConfig(ADC1, ch, 1, ADC_SampleTime_144Cycles );	//ADC1,ADC通道,480个周期,提高采样时间可以提高精确度			    
